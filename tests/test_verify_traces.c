...
int main(int argc, char **argv)
{
    ...
    while ((c = getopt(argc, argv, "f:m:n:o:e:vS")) != -1) {
        switch (c) {
            case 'f':
                filename = optarg;
                break;
    ...
    if (parasail_can_use_sse2()) {
        if (test_scores) {
            check_functions(parasail_nw_trace_sse2, sequences, sizes, limit, matrix, gap);
            check_functions(parasail_sg_trace_sse2, sequences, sizes, limit, matrix, gap);
            check_functions(parasail_sw_trace_sse2, sequences, sizes, limit, matrix, gap);
        }
    }
#endif
    ...
    if (parasail_can_use_sse41()) {
        if (test_scores) {
            check_functions(parasail_nw_trace_sse41, sequences, sizes, limit, matrix, gap);
            check_functions(parasail_sg_trace_sse41, sequences, sizes, limit, matrix, gap);
            check_functions(parasail_sw_trace_sse41, sequences, sizes, limit, matrix, gap);
        }
    }
#endif
    ...
    if (parasail_can_use_avx2()) {
        if (test_scores) {
            check_functions(parasail_nw_trace_avx2, sequences, sizes, limit, matrix, gap);
            check_functions(parasail_sg_trace_avx2, sequences, sizes, limit, matrix, gap);
            check_functions(parasail_sw_trace_avx2, sequences, sizes, limit, matrix, gap);
        }
    }
#endif
    ...
    {
        if (test_scores) {
            check_functions(parasail_nw_trace_knc, sequences, sizes, limit, matrix, gap);
            check_functions(parasail_sg_trace_knc, sequences, sizes, limit, matrix, gap);
            check_functions(parasail_sw_trace_knc, sequences, sizes, limit, matrix, gap);
        }
    }
#endif

    if (test_scores) {
        check_functions(parasail_nw_trace_disp, sequences, sizes, limit, matrix, gap);
        check_functions(parasail_sg_trace_disp, sequences, sizes, limit, matrix, gap);
        check_functions(parasail_sw_trace_disp, sequences, sizes, limit, matrix, gap);
    }
